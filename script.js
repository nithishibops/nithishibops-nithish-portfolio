...
const portfolioData = {
  ...
  description:
    "With 5+ years of experience across banking alliances, merchant onboarding, payment operations, KYC/AML and investment operations, I turn transaction and operational data into executive dashboards and decision-support reporting — backed by Power BI, DAX and Advanced Excel/VBA automation. Also available for freelance dashboard and automation projects.",
  ...
  liveSite: "https://nithishibops.github.io/nithishibops-nithish-portfolio/#home"
};

/* Curated GitHub star lists (shown in the Freelance/Services section) */
const resourceLists = [
  { title: "Excel Macros Collection", url: "https://github.com/stars/nithishibops/lists/macros" },
  { title: "Mail Merge Templates Collection", url: "https://github.com/stars/nithishibops/lists/mail-merge" }
];
...
const projects = [
  {
    ...
    github: "https://github.com/nithishibops/E-Comerce-Analytics-Dashboard",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/Hotel-Analytics",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/hospital-analytics-dashboard",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/retail-sales-analytics-dashboard",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/banking-operations-dashboard",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/hr-analytics-dashboard",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/payment-gateway-analysis",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/supply-chain-analytics-dashboard",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/Manufacturing-Operations-Dashboard---Falcon-Manufacturing-LLC",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/FinanceBudget-Analytics-Dashboard",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/Population-Analytics-Dashboard",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/sales-analytics-dashboard",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/productivity-dashboard-excel",
  ...
  },
  {
    ...
    github: "https://github.com/nithishibops/attendance-dashboard-excel",
...
const experience = [
  {
    ...
    description:
      "Available on weekends (Saturdays &amp; Sundays) for freelance and contract work — building Power BI dashboards, Excel/VBA automation and Microsoft 365-based reporting solutions for businesses and individuals, without conflicting with full-time work commitments.",
    points: [
      "Dedicate weekend hours to design and build end-to-end Power BI dashboards with DAX measures, Power Query transformations and interactive reporting.",
      ...
      "Open to new weekend freelance engagements — dashboards, automation, and Microsoft Office-based data consulting."
    ]
  },
  {
...
setLink("liveSiteLink", portfolioData.liveSite);
...
/* Curated GitHub resource lists (macros / mail merge) */
const resourceListsRow = document.getElementById("resourceListsRow");

if (resourceListsRow && resourceLists.length) {
  resourceListsRow.innerHTML = resourceLists
    .map(item => `<a class="resource-link" href="${item.url}" target="_blank" rel="noopener">${item.title} ↗</a>`)
    .join("");
}
    ...
    <article class="project-card" data-category="${project.filter.join(" ")}">
      ...
      <div class="project-content">
        ...
        <div class="project-links">
          ...
          ${
            project.github
              ? `<a class="project-github" href="${project.github}" target="_blank" rel="noopener">GitHub ↗</a>`
              : ""
          }
        </div>
      </div>
