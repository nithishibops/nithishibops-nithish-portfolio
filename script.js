const projects = [
  ...
  {title:'NASDAQ Dubai — UAE Capital Markets Analytics', category:'Capital Markets', type:'STOCK MARKET / EXCHANGE ANALYTICS', desc:'UAE capital-markets dashboard covering deals, capital raising, operations, SLA, exceptions, reconciliation, settlement and budget performance across exchange workflows.', tags:['NASDAQ Dubai','Capital Markets','Markets'], url:'https://nithishibops.github.io/NASDAQ_Dubai_UAE_Capital_Markets_Analytics/', accent:'gold'},
  ...
  {title:'Airlines Analytics Dashboard', category:'Aviation', type:'AIRLINE ANALYTICS', desc:'Interactive airline performance dashboard covering operations, commercial KPIs, routes, passengers and executive aviation insights.', tags:['Airlines','Operations','Analytics'], url:'https://emirates-one-page-dashboard.vercel.app/', accent:'sky'},
  {title:'Emirates Analytics Dashboard', category:'Aviation', type:'EMIRATES / AIRLINE ANALYTICS', desc:'Multi-page Emirates-inspired analytics experience covering executive performance, flight operations, revenue, profitability, routes and network insights.', tags:['Emirates','Aviation','Analytics'], url:'https://emirates-dashboard-one.vercel.app/', accent:'red'},
  ...
  {title:'Supply Chain Analytics Dashboard', category:'Operations', type:'SUPPLY CHAIN', desc:'Inventory, logistics, procurement and supply-chain operational performance analysis.', tags:['Power BI','Supply Chain','Inventory'], url:'https://nithishibops.github.io/supply-chain-analytics-dashboard/', accent:'gold'},
  {title:'Uniglobe Holdings — Group Business Analytics', category:'Operations', type:'GROUP BUSINESS / COMMERCIAL ANALYTICS', desc:'Four-page UAE group analytics portfolio covering executive performance, sales & commercial analytics, inventory & supply chain, and customer, marketing & hospitality operations using a clearly labelled synthetic dataset.', tags:['Power BI','Commercial Analytics','Operations'], url:'https://unique-global.vercel.app/executive', accent:'red'},
