...
const portfolioData = {
  name: "Nithish Kumar",
  title: "Data Analytics & Banking Operations Professional",
  description:
    "Banking and financial-services operations professional with 5+ years of experience across banking alliances, merchant onboarding, payment operations, KYC/AML and investment operations. I combine domain expertise with Power BI, DAX, Advanced Excel/VBA, MIS reporting and process automation to support operational monitoring and decision-making.",
...
const skills = [
  ...
  { icon: "M365", title: "Microsoft 365 Automation", description: "Automation across Excel, Word and PowerPoint workflows for recurring reporting and documentation." }
];
